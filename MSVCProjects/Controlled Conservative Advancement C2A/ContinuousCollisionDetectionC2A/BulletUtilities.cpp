...
btTriangleIndexVertexArray* BulletUtilities::createTriangleIndexVertexArray(double *verticesArray,int *facesArray,int numVertices,int numFaces)
{

	// vertices and faces data are assumed to have been properly transformed

	btTriangleIndexVertexArray* triangleIndexVertexArray = new btTriangleIndexVertexArray(numFaces,facesArray,3*sizeof(int),numVertices,verticesArray,3*sizeof(btScalar));
