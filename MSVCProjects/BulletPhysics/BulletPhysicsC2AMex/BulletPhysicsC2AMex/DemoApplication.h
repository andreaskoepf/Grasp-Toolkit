...
/* List of changes
1 - Line 83: added attribute bool isSimulationRunning;
2 - Line 120: commented out virtual void initPhysics()
3 - Line 86: added attribute int WindowHandle in order to have the ability of destroying the window at exit instead of calling glutLeaveMainLoop.
4 - Line 132 : added method setWindowHandle in order to mantain a reference to the graphics window.
*/
...
protected:
	...
	// added this attribute:	Used by Simulation Manager
