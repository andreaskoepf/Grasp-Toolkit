...
link.JointValues=theta0;
linkTransform0=Algorithms.rotation('z',theta0);
%=Solid.rotation('x',-pi/2)*Solid.translation('z',4);
link.JointValues=thetaf;
linkTransformf=Algorithms.rotation('z',thetaf);
...
if(bool)
    ...
    link.Frame=Algorithms.rotation('z',theta_toc + theta0);
    box.Frame=ccdResultStruct.TOC_TransformB;
    link';
    box';
end
