...
% resolution
%resolution=[7 4];
resolution=[5 2;5 3;7 4;8 5;12 8];
...
excelData  ={'Resolution Per Contact','Depth','Number Iterations','Total Timev (seconds)','Number EP Facets','Contact Model','Tolerance','Friction','WS Vertices','WS Facets'};
...
newRange = t+3;
xlswrite('GraspQuality_Results2',{'Contact Points'},'Test4',['A' num2str(newRange)])
newRange = newRange+1;
xlswrite('GraspQuality_Results2',num2cell(r),'Test4',['A' num2str(newRange)]);
newRange = newRange+6;
xlswrite('GraspQuality_Results2',{'Contact Normals'},'Test4',['A' num2str(newRange)])
newRange = newRange+1;
xlswrite('GraspQuality_Results2',num2cell(n),'Test4',['A' num2str(newRange)])