...
xlswrite('GraspQuality_Results2',excelData,'Test2','A1');

% writing contact points
newRange = t+3;
xlswrite('GraspQuality_Results2',{'Contact Points'},'Test2',['A' num2str(newRange)])
newRange = newRange+1;
xlswrite('GraspQuality_Results2',num2cell(r),'Test2',['A' num2str(newRange)]);
newRange = newRange+6;
xlswrite('GraspQuality_Results2',{'Contact Normals'},'Test2',['A' num2str(newRange)])
newRange = newRange+1;
xlswrite('GraspQuality_Results2',num2cell(n),'Test2',['A' num2str(newRange)])
