...
obj.scale(2);
%%
objectTransform = Geometry.translation('zxy',[-2 0 0]);
objectColor = [135  206 250]/255;
palmStartTransform = Geometry.translation('zyx',[2 -5 0])*Geometry.rotation('xz',[pi/2 -pi/6]);
palmEndTransform = palmStartTransform*Geometry.translation('z',-10);
testNo = 3;
...
%% writing to excel
xlswrite('GraspSynthesis_Experiment_Results',excelData,'ThreeFinger_FCTest','A1')
